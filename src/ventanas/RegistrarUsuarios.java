...
public class RegistrarUsuarios extends javax.swing.JFrame {
   ...
   private void initComponents() {
      ...
      getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 10, 220, 40));
      ...
      txt_nombre.setFont(new java.awt.Font("Dubai Medium", 1, 16)); // NOI18N
      ...
      getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 60, 20));

      jLabel5.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
      jLabel5.setForeground(new java.awt.Color(255, 255, 255));
      jLabel5.setText("Permisos de:");
      getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 80, 20));

      jLabel6.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
      jLabel6.setForeground(new java.awt.Color(255, 255, 255));
      jLabel6.setText("Username:");
      getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 50, 70, 20));

      jLabel7.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
      jLabel7.setForeground(new java.awt.Color(255, 255, 255));
      jLabel7.setText("Password:");
      getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 110, 70, 20));

      txt_mail.setBackground(new java.awt.Color(153, 153, 255));
      txt_mail.setFont(new java.awt.Font("Dubai Medium", 1, 16)); // NOI18N
      ...
      txt_telefono.setFont(new java.awt.Font("Dubai Medium", 1, 16)); // NOI18N
      ...
      txt_username.setFont(new java.awt.Font("Dubai Medium", 1, 16)); // NOI18N
      ...
      txt_password.setFont(new java.awt.Font("Dubai Medium", 1, 16)); // NOI18N
      ...
      getContentPane().add(jLabel_errorPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 190, -1, -1));
      getContentPane().add(jLabel_errorUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 110, -1, -1));
   ...
   private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
      ...
      // Validación del formato del username (Debe comenzar con 'M' seguido de 8
      // dígitos)
      if (!username.matches("M\\d{8}")) {
         txt_username.setBackground(Color.red);
         JOptionPane.showMessageDialog(null, "El username debe comenzar con 'M' seguido de 8 dígitos numéricos");
         validacion++;
      }

      // Validación del password (Debe tener al menos 8 caracteres, mayúsculas,
      ...
      if (!validarPassword(pass)) {
         ...
         // Si el password es fuerte, indicar que es fuerte o débil
         if (pass.length() >= 8) {
            ...
            JOptionPane.showMessageDialog(null, "La contraseña es " + strength);
         }
      }
      ...
      try {
         ...
         if (rs.next()) {
            ...
            if (validacion == 0) {
               try {
                  ...
                  if (permisos_string.equals("Obstetra")) {
                     try {
                        Connection cn3 = Conexion.conectar();
                        PreparedStatement pst3 = cn3.prepareStatement(
                              "INSERT INTO obstetras (nombre_obstetra, dni, correo) VALUES (?, ?, ?)");
                        pst3.setString(1, nombre);
                        pst3.setString(2, username); // usamos el username como DNI
                        pst3.setString(3, mail);
                        pst3.executeUpdate();
                        cn3.close();
                     } catch (Exception e) {
                        System.err.println("Error al insertar obstetra: " + e);
                     }
                  }
         ...
         System.err.println("Error en validad nombre de usuario." + e);
   ...
   // Método para validar la complejidad del password
   ...
   public static void main(String args[]) {
      ...
      try {
         ...
         java.util.logging.Logger.getLogger(RegistrarUsuarios.class.getName()).log(java.util.logging.Level.SEVERE, null,
               ex);
