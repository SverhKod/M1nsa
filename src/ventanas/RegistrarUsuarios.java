...
public class RegistrarUsuarios extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        // Validación del formato del username (Debe comenzar con 'M' seguido de 8 dígitos)
        ...
        // Validación del password (Debe tener al menos 8 caracteres, mayúsculas, minúsculas, números y símbolos)
        if (!validarPassword(pass)) {
            txt_password.setBackground(Color.red);
            validacion++;
            JOptionPane.showMessageDialog(null, "La contraseña debe tener al menos 8 caracteres, incluyendo mayúsculas, minúsculas, números y símbolos");
        } else {
            // Si el password es fuerte, indicar que es fuerte o débil
            if (pass.length() >= 8) {
                String strength = "Débil";
                if (pass.matches(".*[A-Z].*") && pass.matches(".*[a-z].*") && pass.matches(".*\\d.*") && pass.matches(".*[!@#$%^&*(),.?\":{}|<>].*")) {
                    strength = "Fuerte";
                }
